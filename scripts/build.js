...
exports.search = exports.events = exports.app = undefined;

var _initapp = __webpack_require__(120);

var _eventsforcities = __webpack_require__(119);

var _eventsforareas = __webpack_require__(118);

var _data = __webpack_require__(117);

var _search = __webpack_require__(121);

var _jquery = __webpack_require__(316);
...
var Bootstrap = __webpack_require__(122);
...
var ExampleData = exports.ExampleData = function ExampleData() {
    ...
    this.loadButton.addEventListener('click', function () {
        ...
        _app.app.initCountriesList(json);
        _app.app.cities = JSON.parse(localStorage.getItem('cities')) || [];
    });
};
...
var EventsForAreas = exports.EventsForAreas = function () {
    function EventsForAreas() {
        ...
        this.wrapper.addEventListener('click', function (event) {
            if (event.target.className === 'edit-area') {
                ...
                _app.app.cities[_this.index].cityAreas.forEach(function (item, i) {
                    if (item.id === +areaId) {
                        _this.indexArea = i;
                    }
                });

                var area = _app.app.cities[_this.index].cityAreas[_this.indexArea];
                _this.name = area.name;
        ...
        this.saveArea.addEventListener('click', function (event) {
            ...
            if (modalLabel === 'edit') {
                ...
                area.id = _app.app.cities[_this.index].cityAreas[_this.indexArea].id;
                ...
                var id = _app.app.cities[_this.index].id + 'areas';
                var areasName = document.getElementById(id);

                _app.app.cities[_this.index].cityAreas[_this.indexArea] = area;
                var areasNames = [];
                _app.app.cities[_this.index].cityAreas.forEach(function (item) {
                    areasNames.push(item.name);
                });
                areasNames = areasNames.length < 1 ? _constants.constants.noAreas : areasNames.join(', ');
    ...
    _createClass(EventsForAreas, [{
        ...
        value: function validateArea(area) {
            ...
            var bool = _app.app.cities[this.index].cityAreas.every(function (item) {
                return item.name.toUpperCase() !== area.name.toUpperCase();
            });
            if (!bool) {
                this.errorEl.innerHTML = _constants.constants.alertMessageForExistingArea;
                return false;
            }
            return true;
        }
    ...
    function EventsForCities() {
        ...
        this.wrapper.addEventListener('click', function (event) {
            if (event.target.className === 'edit-city') {
                ...
                _this.name = _app.app.cities[_this.index].name;
...
var Search = exports.Search = function () {
    function Search() {
        ...
        this.searchButtonCountries.addEventListener('click', function () {
            ...
            _this.clearFilterErrorMessages('countries-error', 'atrributes-error', 'citizens-error');
            _this.showAlertOrRenderFilters(_constants.constants.alertNoCountries, countries, 'countries-error');
        ...
        this.dropDownButton.addEventListener('click', function () {
            ...
            var arrOfMinAndMax = _this.findMinAndMaxValuesOfCitizens(_app.app.cities);
        ...
        this.searchAttrButton.addEventListener('click', function () {
            ...
            _this.clearFilterErrorMessages('countries-error', 'atrributes-error', 'citizens-error');
            _this.showAlertOrRenderFilters(_constants.constants.alertNoCitiesWithAttr, cities, 'atrributes-error');
        });
        ...
        this.searchForCitizens.addEventListener('click', function () {
            ...
            if (isNaN(minCitizensValue) || isNaN(maxCitizensValue)) {
                var errorEl = document.getElementById('citizens-error');
                errorEl.innerHTML = _constants.constants.alertForAreaFilter;
                return;
            }
            var cities = _this.findAreasByRangeOfCitizens(minCitizensValue, maxCitizensValue);
            _this.showAlertOrRenderFilters(_constants.constants.alertNoAreasWithSuchCitizens, cities, 'citizens-error');
        });
    }
    ...
    _createClass(Search, [{
        ...
        value: function findMinAndMaxValuesOfCitizens(cities) {
            var arr = [];
            cities.forEach(function (item) {
                item.cityAreas.forEach(function (item) {
        ...
        key: 'showAlertOrRenderFilters',
        value: function showAlertOrRenderFilters(message, cities, id) {
            if (!cities.length) {
        ...
        key: 'clearFilterErrorMessages',
        value: function clearFilterErrorMessages() {
            for (var i = 0; i < arguments.length; i++) {
                var errorEL = document.getElementById(arguments[i]);
                errorEL.innerHTML = '';
            }
        }
    }]);
